...
TRACKED=sorted([
"mg_ca/__init__.py","mg_ca/constants.py","mg_ca/contracts.py","mg_ca/foundation.py",
"tests/conftest.py","tests/test_mg_ca_foundation.py","README.md","README_EN.md","VERSION","pyproject.toml","CHANGELOG.md",
