...
> `3_chemical` 허브가 커져도 드리프트하지 않도록 하기 위한 운영 규칙.

## 1. Three-Layer Rule

`3_chemical` 안의 엔진은 반드시 아래 셋 중 하나로 분류한다.
...
1. 기능 수정은 정본에서 먼저 한다.
2. `3_chemical`은 흐름 보기와 graft 실험을 위한 허브다.
...
1. [ELEMENT_REGISTRY.md](/Users/jazzin/Desktop/00_BRAIN/02_SYSTEMS/ENGINE_HUB/3_chemical/ELEMENT_REGISTRY.md)에 등록
2. 해당 원소가 foundation 후보인지 판단
3. [ELEMENT_FOUNDATION_TEMPLATE.md](/Users/jazzin/Desktop/00_BRAIN/02_SYSTEMS/ENGINE_HUB/3_chemical/ELEMENT_FOUNDATION_TEMPLATE.md) 기준으로 scaffold 생성
...
`3_chemical`은 장기적으로 다음 흐름을 중심으로 확장한다.
