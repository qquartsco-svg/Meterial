...
TRACKED=sorted([
"iron/__init__.py","iron/constants.py","iron/contracts.py","iron/foundation.py",
"tests/conftest.py","tests/test_iron_foundation.py","README.md","README_EN.md","VERSION","pyproject.toml","CHANGELOG.md",
