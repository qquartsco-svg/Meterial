...
TRACKED=sorted(['sulfur/__init__.py','sulfur/constants.py','sulfur/contracts.py','sulfur/foundation.py','tests/conftest.py','tests/test_sulfur_foundation.py','README.md','README_EN.md','VERSION','pyproject.toml','CHANGELOG.md','scripts/generate_signature.py','scripts/verify_signature.py'])
