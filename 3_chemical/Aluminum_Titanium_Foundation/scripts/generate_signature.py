...
TRACKED=sorted([
"al_ti/__init__.py","al_ti/constants.py","al_ti/contracts.py","al_ti/foundation.py",
"tests/conftest.py","tests/test_al_ti_foundation.py","README.md","README_EN.md","VERSION","pyproject.toml","CHANGELOG.md",
