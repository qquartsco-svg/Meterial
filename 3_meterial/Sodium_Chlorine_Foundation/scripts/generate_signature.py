...
TRACKED=sorted([
"sodium_chlorine/__init__.py","sodium_chlorine/constants.py","sodium_chlorine/contracts.py","sodium_chlorine/foundation.py",
"tests/conftest.py","tests/test_sodium_chlorine_foundation.py","README.md","README_EN.md","VERSION","pyproject.toml","CHANGELOG.md",
