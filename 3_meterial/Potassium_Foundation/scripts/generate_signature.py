...
TRACKED=sorted(['potassium/__init__.py','potassium/constants.py','potassium/contracts.py','potassium/foundation.py','tests/conftest.py','tests/test_potassium_foundation.py','README.md','README_EN.md','VERSION','pyproject.toml','CHANGELOG.md','scripts/generate_signature.py','scripts/verify_signature.py'])
