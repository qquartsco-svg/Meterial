...
TRACKED=sorted(["fluorine/__init__.py","fluorine/constants.py","fluorine/contracts.py","fluorine/foundation.py","tests/conftest.py","tests/test_fluorine_foundation.py","README.md","README_EN.md","VERSION","pyproject.toml","CHANGELOG.md","scripts/generate_signature.py","scripts/verify_signature.py"])
