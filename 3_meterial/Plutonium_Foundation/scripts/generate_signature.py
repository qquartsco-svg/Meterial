...
TRACKED=['pu/__init__.py', 'pu/constants.py', 'pu/contracts.py', 'pu/foundation.py', 'tests/conftest.py', 'tests/test_pu_foundation.py', 'README.md', 'README_EN.md', 'VERSION', 'pyproject.toml', 'CHANGELOG.md', 'scripts/generate_signature.py', 'scripts/verify_signature.py']
def sha(p):
