...
TRACKED=sorted(['cu_zn/__init__.py','cu_zn/constants.py','cu_zn/contracts.py','cu_zn/foundation.py','tests/conftest.py','tests/test_cu_zn_foundation.py','README.md','README_EN.md','VERSION','pyproject.toml','CHANGELOG.md','scripts/generate_signature.py','scripts/verify_signature.py'])
