...
TRACKED=sorted(['mcn/__init__.py','mcn/constants.py','mcn/contracts.py','mcn/foundation.py','tests/conftest.py','tests/test_mcn_foundation.py','README.md','README_EN.md','VERSION','pyproject.toml','CHANGELOG.md','scripts/generate_signature.py','scripts/verify_signature.py'])
